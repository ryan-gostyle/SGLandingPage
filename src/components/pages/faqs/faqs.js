            ...
            <div className="col-24 sections section-4">
                ...
                <Row className="rowWidth"> 
                    <Col style={{maxWidth:900,margin:'0 auto',textAlign:'left'}}>
                        ...
                        <Panel header="How would you know what style to give me?" id="accordion" key="1" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}}>
                            <ul>
                                <li>
                        ...
                        <Panel header="What if it doesn't fit me?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="2">
                        ...
                        <Panel header="Who will be styling me?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="3">
                            <ul>
                                <li>
                        ...
                        <Panel header="Where are all these clothes coming from?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="4">
                            <ul>
                                <li>
                        ...
                        <Panel header="How many pieces do I expect inside my box?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="5">
                            <ul>
                                <li>
                        ...
                        <Panel header="Can I order a box for someone else?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="6" >
                            <ul>
                                <li>
                        ...
                        <Panel header="Do you accept Cash on Delivery as payment?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="7" >
                            <ul>
                                <li>
                        ...
                        <Panel header="What are your available payment options?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="8" >
                            <ul>
                                <li>
                        ...
                        <Panel header="How long will it take you to ship my order?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="9" >
                            <ul>
                                <li>
                        ...
                        <Panel header="What is the delivery lead time? " id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="10" >
                            <ul>
                                <li>
                        ...
                        <Panel header="Do you ship outside Metro Manila?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="11" >
                            <ul>
                                <li>
                        ...
                        <Panel header="Do you ship outside the Philippines?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="12" >                        
                            <ul>
                                <li>
                        ...
                        <Panel header="What is Shazuums?" id="accordion" style={{backgroundColor:"#fff",fontWeight:500,color:"#fff"}} key="13" >                        
                            <ul>
                                <li>
